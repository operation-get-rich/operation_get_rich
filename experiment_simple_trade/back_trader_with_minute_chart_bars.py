...
STATE_FILE_LOCATION = 'state_polygon_01_01_minute_chart_bars.json'
        ...
        if i + 2 < len(stock_df_minutes):
            ...
            if close < open and next_close > next_open and next_high_2 > next_high:
                ...
                for j in range(len(stock_df_ticks)):
                    # TODO: My approach of dealing with Quote is totally wrong here
                    # TODO: Implement the `quote_state` approach
                    (
                        sip_timestamp,
                        bid_price,
                        bid_size,
